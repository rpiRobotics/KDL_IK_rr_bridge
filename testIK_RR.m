clear;
ikservice = RobotRaconteur.Connect('tcp://localhost:4343/KdlIkService/KdlIkService/KDLIK');
%% Robot Parameters
...
[ P_v,H_v,R_EE_v,ikTgt_v ] = ReshapeData( P,H,R_EE,ikTgt );
%% Call IK function
rslt = ikservice.getIK(P_v,H_v,R_EE_v,ikTgt_v,flag_fixed,q_fixed,q_init_guess);
